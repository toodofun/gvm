...
func TestValidateURL(t *testing.T) {
	tests := []struct {
		...
		{name: "invalid URL format", url: "not-a-url", wantErr: true, errMsg: "must use HTTPS"},
		{name: "URL with spaces", url: "https://example.com/file name.tar.gz", wantErr: true, errMsg: "spaces"},
	}
